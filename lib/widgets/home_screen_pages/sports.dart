...
import 'package:profolio/routes/add_sport.dart'; // Import AddSport route
...
void addSport(String sportTitle, String sportDescription) async {
 ...
 // context,
  ...
  Widget build(BuildContext context) {
    final sportListProvider = Provider.of<SportListProvider>(context); // Access provider
  ...
  // Access SportListProvider instance
                                  final sportListProvider = Provider.of<SportListProvider>(context, listen: false);
  ...
  // Check if data is returned (optional)
    ...
    // Use the stored provider instance to add the sport
                                sportListProvider.addSport(sportTitle, sportDescription);
                                }
                              },
            ...
            Expanded(
              child: ListView(
                children: sportListProvider.sports // Access sports list from provider
                    .map((sport) => ListWidget(title: sport.sportTitle, description: sport.sportDescription))
                    .toList(),
              ),
